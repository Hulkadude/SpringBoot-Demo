...
import com.nineleaps.SpringBootDemo.GithubProperties;
...
public class GithubClient {
	...
	private String EVENT_ISSUES_URL = "https://api.github.com/repos/{owner}/{repo}/issues/events";
	...
	public GithubClient(RestTemplateBuilder builder, GithubProperties properties, MeterRegistry registry) {
		this.restTemplate = builder.additionalInterceptors(new GithubAppTokenInterceptor(properties.getToken()))
				.additionalInterceptors(new MetricsInterceptor(registry)).build();
	}
	...
	public List<RepositoryEvents> fetchEventsList(String orgName, String repoName) {
